...
public class Ejer10 {
    public static void main (String [] args) {
        ...
        int num1= 2;
        int num2= 6;
        int resultado = num1*num2/1 + num1*num2/2 + num1*num2/3 + num1*num2/4 + num1*num2/5 + num1*num2/6 + num1*num2/7 + num1*num2/8 + num1*num2/9 + num1*num2/10 + num1*num2/11 + num1*num2/12 + num1*num2/13 + num1*num2/14 + num1*num2/15;
